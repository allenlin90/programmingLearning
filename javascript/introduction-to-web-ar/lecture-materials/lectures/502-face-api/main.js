...
document.addEventListener('DOMContentLoaded', () => {
  const start = async() => {
    ...
    const textures = {};
    textures['happy'] = await loadTexture('../../assets/openmoji/1-f600');
    textures['angry'] = await loadTexture('../../assets/openmoji/1-f621');
    textures['sad'] = await loadTexture('../../assets/openmoji/1-f625');
    textures['neutral'] = await loadTexture('../../assets/openmoji/1-f610');
